...
export default function AppTopNav() {
  ...
  return (
    <>
      <nav
        className="fixed top-3 left-1/2 -translate-x-1/2 w-[95%] max-w-[1400px] z-50 h-[52px] rounded-xl flex items-center px-4 gap-4 text-foreground"
        style={{
      ...
      >
        ...
        <div className="flex items-center shrink-0">
          <img src={logo} alt="Aceleriq" className="h-10 w-auto" />
        </div>
